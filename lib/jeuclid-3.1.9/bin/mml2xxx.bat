...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="mml2xxx" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" net.sourceforge.jeuclid.app.Mml2xxx %CMD_LINE_ARGS%
